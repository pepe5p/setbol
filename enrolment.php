...
<head>
    ...
    <title>UKS Setbol Oświęcim | Nabór</title>
		...
		<section>
			<div class="navigbar navbar">
				...
				<div class="titlebox pb1">
					<div class="title p1"><i class="icon-user-plus"></i> NABÓR</div>
				</div>
				<div class="container">
						...
						<div class="box col-md-4">
							<div class="flipbox">
								<div class="flip up nimg">
									<div class="icon">SP NR11</div>
								</div>
								<div class="flip down" onclick="link('')">
						...
						<div class="box col-md-4">
							<div class="flipbox">
								<div class="flip up timg">
									<div class="icon">SMS PZ NR2 SOMSiT</div>
								</div>
								<div class="flip down" onclick="link('')">
									<div class="downborder">
										<div class="icon">ZOBACZ <i class="icon-right-circled"></i></div>
